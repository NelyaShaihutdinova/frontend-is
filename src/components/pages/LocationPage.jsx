...
const LocationPage = () => {
    ...
    const goToPreviousPage = async () => {
        if (currentPage > 1) {
            ...
            const updatedData = await fetchData('/location/show', filterColumnRef, filterRef, sortedRef, currentPage - 1, token);
            setData(updatedData);
        }
    };
    ...
    const validateFields = (fields) => {
        const validationMessages = [
            ...
            {
                condition: isNaN(fields.z) || fields.z <= 0,
                message: "Z must be a number more than zero"
            },
        ];
    ...
    const getFields = () => ({
        ...
        z: parseFloat(zRef.current?.value),
    });
    ...
    const createLocation = async () => {
        ...
        const result = await postData(`/location/create`, fields);
    ...
    const updateLocation = async () => {
        ...
        const url = `/location/update/${fields.id}`;
    ...
    const deleteLocation = async () => {
        ...
        const url = `/location/delete/${id}?replace=${replaceId}`;
            ...
            <div className="show-table-container">
                ...
                <div className="block">
                    ...
                    <div style={{display: "flex"}}>
                        <button className="btn" onClick={updateLocation}>Update</button>
                        <button className="btn" onClick={createLocation}>Create</button>
                    </div>
                </div>
                <div className="block">
                    <div className="fields">
                    ...
                    <br/>
                    <button className="btn" onClick={deleteLocation}>Delete</button>
                </div>
            </div>
        </>
    );
